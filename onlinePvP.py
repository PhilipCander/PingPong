...
class oPvP:
    ...
    def load_data(self):
        ...
        self.paddleA.rect.x = self.startPos[0]
        self.paddleA.rect.y = self.startPos[1]
    ...
    def update(self):
        self.p2Pos = read_pos(self.n.send(make_pos((self.paddleA.rect.x, self.paddleA.rect.y))))
        self.paddleB.rect.x = self.p2Pos[0]
        self.paddleB.rect.y = self.p2Pos[1]
